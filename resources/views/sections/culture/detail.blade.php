                    ...
                    <div class="card-body">
                        <div class="d-sm-flex d-block align-items-center justify-content-between align-items-center mb-9">
                            <div class="d-flex align-items-center mb-4">
                                <div>
                                    <a href="{{ route('culture.index') }}" class="d-flex align-items-center"><i
                                            class="ti ti-arrow-left me-3" style="font-size: 20px; color: black"></i>
                                    </a>
                                </div>
                                <div>
                                    <span class="card-title fw-semibold me-3">Detail Culture : {{ $culture->name_culture }}
                                    </span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6">
                                ...
                                <p> <a href="{{ $culture->url_youtube }}" target="_blank">{{ $culture->url_youtube }}</a>
                                </p>
                            </div>
                        </div>
                        <div class="row mb-2">
                        ...
                        <div class="row mb-2 justified-text">
                            <div class="col-md-12">
                                ...
                                @foreach ($culture->culture_photos as $culture_photo)
                                    <img src="{{ asset('storage/' . $culture_photo->photo_path) }}" alt="Food Photo"
                                        width="128px">
                                @endforeach
                            </div>
