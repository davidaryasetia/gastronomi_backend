                    ...
                    <div class="card-body">
                        <div class="d-sm-flex d-block align-items-center justify-content-between align-items-center mb-9">
                            <div class="d-flex align-items-center mb-4">
                                ...
                                <div>
                                    <span class="card-title fw-semibold me-3">Detail Restaurant : {{ $restaurant->name_restaurant }}
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-md-6 justified-text">
                                ...
                                <p> <a href="{{ $restaurant->url_link_map }}" target="_blank">{{ $restaurant->url_link_map }}</a> </p>
                            </div>
                        ...
                        <div class="row mb-2 justified-text">
                            <div class="col-md-12">
                                ...
                                @foreach ($restaurant->restaurant_photos as $restaurant_photo)
                                    <img src="{{ asset('storage/' . $restaurant_photo->photo_path) }}" alt="Restaurant Photo"
                                        width="128px">
                                @endforeach
                            </div>
